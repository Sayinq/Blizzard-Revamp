  ...
  useEffect(() => {
    ...
    return (
        ...
        <div className="flex w-[900px] h-full justify-center items-center">
            <div className="wrapper text-2xl text-[#D2D2D2] text-center" ref={textRef}>
            ...
            <h2 id="line" className="">one of the most successful</h2>
            <h2 id="line" className="">and respected in</h2>
